 ...
 */
export function joinPaths(sourcePath: string, newPath: string) {
...
export function listContents(directoryPath: string) {
...
export function writeFileData(filePath: string, data: string) {
...
export function purgeFile(filePath: string) {
  try {
    if (!fileExists(filePath)) {
